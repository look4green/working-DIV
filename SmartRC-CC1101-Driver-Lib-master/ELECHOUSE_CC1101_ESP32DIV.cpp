...
{
  hspi->begin(SCK_PIN, MISO_PIN, MOSI_PIN, SS_PIN); // JT-2
}
/****************************************************************
...
void ELECHOUSE_CC1101::setSpi(void){
  if (cc1101_spi == 0){
    ...
    #elif ESP32
    SCK_PIN = 18; MISO_PIN = 19; MOSI_PIN = 23; SS_PIN = 27;
    #else
    SCK_PIN = 13; MISO_PIN = 12; MOSI_PIN = 11; SS_PIN = 10;
    #endif
  }
...
bool ELECHOUSE_CC1101::getCC1101(void){
  setSpi();
  if ((SpiReadStatus(0x31)>0) && (SpiReadStatus(0x31)<255)) { // JT
    return 1;
  }else{
    return 0;
  }
